# WebSocket Client Resilience Patterns

Detailed detection commands, before/after code examples, and implementation patterns for each of the 6 resilience patterns.
